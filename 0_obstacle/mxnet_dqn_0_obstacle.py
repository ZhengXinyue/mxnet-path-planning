...
os.mkdir(time)
load_model_path1 = '2019-10-31 17:35:00/final main network parameters'
load_model_path2 = '2019-10-31 17:35:00/final target network parameters'
agent.load_model()
