...
from env_0_obstacle import envmodel
...
class DQN:
    ...
    def save_model(self):
        ...
        save_path = self.saver.save(self.sess,
                                    'saved_networks/' + '10_D3QN_PER_image_add_sensor_empty_world_30m' + '_' + self.date_time + "/model.ckpt")
        # ------------------------------
    ...
    def main(self):
        ...
        env_info, jackal_x, jackal_y = env.get_env()
