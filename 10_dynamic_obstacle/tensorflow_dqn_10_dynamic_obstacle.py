...
class DQN:
    def __init__(self):
        ...
        # 静态障碍下训练好的模型
        self.load_path = '/home/zheng/GIt/DRL_Path_Planning/src/tf_pkg/scripts/saved_networks/10_D3QN_PER_image_add_sensor_obstacle_world_30m_2_2019_06_02'
        ...
        # Parameter for LSTM
        self.Num_dataSize = 724  # 360 sensor size + 4 self state size
